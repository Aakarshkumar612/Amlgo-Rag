...
# MUST be the absolute first Streamlit command — nothing st.* before this
st.set_page_config(
...
def get_chunk_count() -> int:
    """Read chunk count from FAISS metadata file."""
    meta_path = config.VECTORDB_DIR / "faiss_meta.json"
    try:
